...
CREATE TABLE usuario (
    ...
    email VARCHAR(255),
    telefono VARCHAR(20),
    password VARCHAR(MAX) COLLATE Latin1_General_BIN2 NOT NULL,
...
INSERT INTO usuario (dni, nombre, email, telefono, password, estado) 
VALUES ('71870353', 'Sandro Bustamante Vasquez', 'furia241@hotmail.com', '973702664', '71870353', 1);

INSERT INTO empresa_usuario (empresa_id, usuario_id, tipo_usuario_id, estado)
VALUES (1, (select id from usuario where dni = '71870353'), 1, 1);
